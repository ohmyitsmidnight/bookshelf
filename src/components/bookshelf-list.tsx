...
// thead and tbody as well as styling is defined
// in the tbody, shows all BookshelfListRows, if any
// if none, then the shelf will show a message, 
// it also includes a loading state
